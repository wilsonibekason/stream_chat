...
import { useWorkspaceController } from "../../services/context/WorkspaceController";

import { StreamChatType } from "../../types/types";

type TeamChannelPreviewProps =
  ChannelPreviewUIComponentProps<StreamChatType> & { type: string };
